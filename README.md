...
To run Aphel, ensure you have Java installed. Clone this repository and use the interpreter (compilation discouraged):
...
#If in windows:
aphel yourfile.aph
#Other OSs, In: src/aphelios
java Aphel.java yourfile.aph
```
